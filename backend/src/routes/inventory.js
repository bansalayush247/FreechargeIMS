...
router.post(
  ROUTES.INVENTORY_ROUTES.CREATE,
  authMiddleware,
  validateSpaceId,
...
router.get(
  ROUTES.INVENTORY_ROUTES.GET_BY_ID,
  authMiddleware,
  validateSpaceId,
  authorize(INVENTORY_PERMISSIONS.VIEW_INVENTORY),
...
router.patch(
  ROUTES.INVENTORY_ROUTES.UPDATE,
  authMiddleware,
  validateSpaceId,
...
router.delete(
  ROUTES.INVENTORY_ROUTES.DELETE,
  authMiddleware,
  validateSpaceId,
