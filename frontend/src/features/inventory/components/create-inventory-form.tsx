        ...
        {isTrackableProduct ? (
          <>
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-500">Optional. Use it for manufacturer warranty or support tracking.</p>
            </div>

            <div className="space-y-2 md:col-span-2">
              <div className="rounded-2xl border border-orange-100 bg-orange-50 px-4 py-3 text-sm text-slate-700">
                Trackable product selected. Asset tag is generated automatically and QR codes are derived from that tag.
              </div>
            </div>
          </>
        ) : null}
